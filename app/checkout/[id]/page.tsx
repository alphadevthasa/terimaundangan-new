...
function CheckoutContent() {
  ...
  return (
    <div style={{ height: '100vh', background: '#0a0807', color: '#f5ecd9', fontFamily: "'Jost', sans-serif", display: 'flex', flexDirection: 'column' }}>
      <nav style={{ padding: isMobile ? '.65rem 1rem' : '.75rem 2rem', borderBottom: '1px solid rgba(201,169,97,.1)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '.75rem', cursor: 'pointer', minWidth: 0 }} onClick={() => router.push('/')}>
          <div style={{ width: '32px', height: '32px', borderRadius: '50%', background: 'linear-gradient(135deg,#c9a961,#8a6d2b)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
